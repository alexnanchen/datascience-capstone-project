...
However, for bigrams and trigrams we see a coverage lower than 0.0001% and 0.000001% respectively.
...
On the plot we can see that the removal of words appearing only once will keep the word coverage at around 90%.
