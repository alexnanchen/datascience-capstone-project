...
EMOTICONSMAP = list(
    c("\u1F600","","GRINNING FACE"),
    c("\u1F601","","GRINNING FACE WITH SMILING EYES"),
    c("\u1F602","","FACE WITH TEARS OF JOY"),
    c("\u1F603","","SMILING FACE WITH OPEN MOUTH"),
    c("\u1F604","","SMILING FACE WITH OPEN MOUTH AND SMILING EYES"),
    c("\u1F605","","SMILING FACE WITH OPEN MOUTH AND COLD SWEAT"),
    c("\u1F606","","SMILING FACE WITH OPEN MOUTH AND TIGHTLY-CLOSED EYES"),
    c("\u1F607","","SMILING FACE WITH HALO"),
    c("\u1F608","","SMILING FACE WITH HORNS"),
    c("\u1F609","","WINKING FACE"),
    c("\u1F60A","","SMILING FACE WITH SMILING EYES"),
    c("\u1F60B","","FACE SAVOURING DELICIOUS FOOD"),
    c("\u1F60C","","RELIEVED FACE"),
    c("\u1F60D","","SMILING FACE WITH HEART-SHAPED EYES"),
    c("\u1F60E","","SMILING FACE WITH SUNGLASSES"),
    c("\u1F60F","","SMIRKING FACE"),
    c("\u1F610","","NEUTRAL FACE"),
    c("\u1F611","","EXPRESSIONLESS FACE"),
    c("\u1F612","","UNAMUSED FACE"),
    c("\u1F613","","FACE WITH COLD SWEAT"),
    c("\u1F614","","PENSIVE FACE"),
    c("\u1F615","","CONFUSED FACE"),
    c("\u1F616","","CONFOUNDED FACE"),
    c("\u1F617","","KISSING FACE"),
    c("\u1F618","","FACE THROWING A KISS"),
    c("\u1F619","","KISSING FACE WITH SMILING EYES"),
    c("\u1F61A","","KISSING FACE WITH CLOSED EYES"),
    c("\u1F61B","","FACE WITH STUCK-OUT TONGUE"),
    c("\u1F61C","","FACE WITH STUCK-OUT TONGUE AND WINKING EYE"),
    c("\u1F61D","","FACE WITH STUCK-OUT TONGUE AND TIGHTLY-CLOSED EYES"),
    c("\u1F61E","","DISAPPOINTED FACE"),
    c("\u1F61F","","WORRIED FACE"),
    c("\u1F620","","ANGRY FACE"),
    c("\u1F621","","POUTING FACE"),
    c("\u1F622","","CRYING FACE"),
    c("\u1F623","","PERSEVERING FACE"),
    c("\u1F624","","FACE WITH LOOK OF TRIUMPH"),
    c("\u1F625","","DISAPPOINTED BUT RELIEVED FACE"),
    c("\u1F626","","FROWNING FACE WITH OPEN MOUTH"),
    c("\u1F627","","ANGUISHED FACE"),
    c("\u1F628","","FEARFUL FACE"),
    c("\u1F629","","WEARY FACE"),
    c("\u1F62A","","SLEEPY FACE"),
    c("\u1F62B","","TIRED FACE"),
    c("\u1F62C","","GRIMACING FACE"),
    c("\u1F62D","","LOUDLY CRYING FACE"),
    c("\u1F62E","","FACE WITH OPEN MOUTH"),
    c("\u1F62F","","HUSHED FACE"),
    c("\u1F630","","FACE WITH OPEN MOUTH AND COLD SWEAT"),
    c("\u1F631","","FACE SCREAMING IN FEAR"),
    c("\u1F632","","ASTONISHED FACE"),
    c("\u1F633","","FLUSHED FACE"),
    c("\u1F634","","SLEEPING FACE"),
    c("\u1F635","","DIZZY FACE"),
    c("\u1F636","","FACE WITHOUT MOUTH"),
    c("\u1F637","","FACE WITH MEDICAL MASK"),
    c("\u1F638","","GRINNING CAT FACE WITH SMILING EYES"),
    c("\u1F639","","CAT FACE WITH TEARS OF JOY"),
    c("\u1F63A","","SMILING CAT FACE WITH OPEN MOUTH"),
    c("\u1F63B","","SMILING CAT FACE WITH HEART-SHAPED EYES"),
    c("\u1F63C","","CAT FACE WITH WRY SMILE"),
    c("\u1F63D","","KISSING CAT FACE WITH CLOSED EYES"),
    c("\u1F63E","","POUTING CAT FACE"),
    c("\u1F63F","","CRYING CAT FACE"),
    c("\u1F640","","WEARY CAT FACE"),
    c("\u1F641","","SLIGHTLY FROWNING FACE"),
    c("\u1F642","","SLIGHTLY SMILING FACE"),
    c("\u1F645","","FACE WITH NO GOOD GESTURE"),
    c("\u1F646","","FACE WITH OK GESTURE"),
    c("\u1F647","","PERSON BOWING DEEPLY"),
    c("\u1F648","","SEE-NO-EVIL MONKEY"),
    c("\u1F649","","HEAR-NO-EVIL MONKEY"),
    c("\u1F64A","","SPEAK-NO-EVIL MONKEY"),
    c("\u1F64B","","HAPPY PERSON RAISING ONE HAND"),
    c("\u1F64C","","PERSON RAISING BOTH HANDS IN CELEBRATION"),
    c("\u1F64D","","PERSON FROWNING"),
    c("\u1F64E","","PERSON WITH POUTING FACE"),
    c("\u1F64F","","PERSON WITH FOLDED HANDS"),
    c("❤","","Heart"),
    c(":-?[)]","","Smile"),
    c(":-?[(]","","Not smile")
)
